...
export default function LoginPage() {
  ...
  const { loginWithEmail, loginWithGoogle, authLoading, syncError } = useProductivityStore();
    ...
    <div className="min-h-screen bg-[#070512] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="relative flex py-1 items-center shrink-0">
          ...
          <span className="flex-shrink mx-3 text-[9px] text-[var(--text-muted)] uppercase tracking-wider font-bold">Or sign in with email</span>
          <div className="flex-grow border-t border-white/5" />
        </div>
