...
import { Sparkles, ArrowRight, Globe, Code, Lock, Mail, Loader2, AlertCircle } from "lucide-react";
...
export default function LoginPage() {
  ...
  const { loginWithEmail, loginWithGoogle, loginWithGithub, authLoading, syncError } = useProductivityStore();
  ...
  const handleOAuthSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOauthLoadingLocal(false);
      setOauthError(err.message || "Failed to connect OAuth provider");
    }
  };
            ...
            >
              ...
              <div className="flex flex-col items-center text-center gap-2">
                ...
                <p className="text-[10px] text-[var(--text-muted)] max-w-[240px]">
                  FocusBoost will connect to your {oauthProvider} identity provider to build and sync your dashboard cloud backup.
                </p>
              </div>
